...
u8   GPIO_u8GetPinValue    (u8 Copy_u8PORT , u8 Copy_u8PIN )
{
	...
	switch(Copy_u8PORT)
	{
		case PORTA: Loc_u8ReturnedValue = GET_BIT( GPIOA -> ODR , Copy_u8PIN); break;
		case PORTB: Loc_u8ReturnedValue = GET_BIT( GPIOB -> ODR , Copy_u8PIN); break;
		case PORTC: Loc_u8ReturnedValue = GET_BIT( GPIOC -> ODR , Copy_u8PIN); break;
	}
